...
public class EmpFlight implements Serializable{
	...
	public EmpFlight(long id, String username, String firstname, String lastname, int age, String password,
			String email, String department, String phone, String role, int accepted, boolean enabled, int version) {
		this.id = id;
